...
typedef void (GL_APIENTRYP PFNGLTEXDIRECTLINEARMAPVIVPROC) (GLenum Target, GLsizei Width, GLsizei Height, GLenum Format, GLvoid ** Logical, const GLuint * Physical);
#endif
/* GL_VIV_clamp_to_border */
#ifndef GL_VIV_clamp_to_border
