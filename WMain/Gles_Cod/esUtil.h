...
enum gm {GMODE_PAINT,        // рисование примитивов
         GMODE_FONT_TON,     // печать шрифта без фона
		 GMODE_FONT_TONFON,  // печать шрифта з фоном
		 GMODE_FONT,         // два предыдущих варианта вместе
		 GMODE_BMP,          // картинка вся
		 GMODE_BMP_NO_WAIT,  // без белого
		 GMODE_BMP_NO_BLACK, // без черного
		 GMODE_BMP_NO_WAIT_COLOR,  // без белого, остальное цветом color
		 GMODE_BMP_NO_BLACK_COLOR  // без черного, остальное цветом color
};
...
extern GLint UnifBgColLoc;
extern GLint UnifGModeLoc; // печать шрифта, шрифта с фоном, рисование
extern GLint UnifMvpMatrixLoc;
